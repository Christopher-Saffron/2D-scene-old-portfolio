  ...
  return (
    ...
    {!('ontouchstart' in window) && (
      <div className='App_particleDiv'>
        <Particle setShowParticles={setShowParticles} showParticles={showParticles} />
      </div>
    )}
      
      <Footer color={color} webpageMode={webpageMode} />
      
      <Ui toggleQuickPreview={toggleQuickPreview} color={color} setColor={setColor} handleClick={handleClick} />
