...
const BigPage = ({IMAGES, showInModal, userScroll, setUserScroll, changeModalImgSrc, changeIsOpen}) => {
    ...
    <>
      {userScroll && (
        <div ref={mainBigScroll} className='bigPage__holder'>
          <img className='bigPage__scrollHandle bigPage__scrollHandle_top' src={IMAGES.scrollRoll} alt='/' />
          <img className='bigPage__scrollHandle bigPage__scrollHandle_bottom' src={IMAGES.scrollRoll} alt='/' />
