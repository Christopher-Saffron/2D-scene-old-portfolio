...
import Languages from "../AboutMePages/Languages";
import Skills from "../AboutMePages/Skills";
import Education from "../AboutMePages/Education";
import History from "../AboutMePages/History";
...
const BigPage = ({ IMAGES, showInModal, userScroll, setUserScroll }) => {
  ...
  const handleCloseScroll = () => {
    ...
    if (
      mainBigScroll.current.classList.contains("bigPage__holder_moreScroll")
    ) {
    ...
    <>
      {userScroll && (
        <div ref={mainBigScroll} className="bigPage__holder">
          <img
            className="bigPage__scrollHandle bigPage__scrollHandle_top"
            src={IMAGES.scrollRoll}
            alt="/"
          />
          <img
            className="bigPage__scrollHandle bigPage__scrollHandle_bottom"
            src={IMAGES.scrollRoll}
            alt="/"
          />
          <div className="bigPage__holder_article">
            {userScroll === "Languages" ? (
              ...
              <>
                ...
                <Education showInModal={showInModal} />
              </>
            ) : userScroll === "History" ? (
              <>
                <div className=" bigPage__holder_imgHolder2 ">
                ...
                <History showInModal={showInModal} />
              </>
            ) : (
              ""
            )}
            ...
            <div className="bigPage__holder_options">
              <div
                className="bigPage__holder_makeItBiggerButton"
                onClick={(e) => {
                  showMoreScroll(e);
                }}
              >
              ...
              <div
                className="bigPage__holder_showText"
                onClick={(e) => {
                  toggleTextAmount(e);
                }}
              >
            ...
            <div
              className="bigPage__holder_exitButton_holder"
              onClick={() => {
                handleCloseScroll(false);
              }}
            >
